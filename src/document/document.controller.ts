...
import { VectorStore } from '../vector-store/vector-store.provider';
...
export class DocumentController {
  ...
  @Post('parse')
  @UseInterceptors(TransformResponseInterceptor)
  async parse(@Body() body: ParseDocsDto) {
    ...
    console.log(
      `${filePath} added to collection ${collectionName}, now contains ${count} documents`,
    );
